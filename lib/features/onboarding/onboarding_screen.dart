...
/// Dark / Light / System selector reused by onboarding and Settings.
class ThemeChooserCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<(ThemeMode, String, IconData, String)> options =
        ...
        for (final (ThemeMode mode, String label, IconData icon, String hint) in options)
          Padding(
            ...
            child: GlassCard(
              ...
              child: Row(
                children: <Widget>[
                  Icon(icon, size: 18, color: app.themeController?.mode == mode ? t.primary : t.textMuted),
